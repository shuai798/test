...
class Curd extends PureComponent {
    ...
    searchList = (page, size) => {
        ...
        dispatch({
            type: 'trackIntention/getTableListInfo',
            payload: {
                ...value,
            },
            callback: (response) => {
    ...
    disposeItem = (record) => {
        const { dispatch } = this.props;
        dispatch({
            type: 'trackIntention/getDetailList',
            payload: {
                id: record.id,
            },
            callback: (response) => {
    ...
    render() {
        const { detailRecord, dataSource, detailVisible, detailId } = this.state;
        const columns = [
            {
                title: '序号',
                dataIndex: 'No',
            ...
            <>
                ...
                <div className="content mt12 flex-1">
                    <div className="mb12 clearfix">
                        <span className="table-title">意向跟踪记录</span>
                    </div>
                ...
                {detailVisible && <DetailForm detailId={detailId} detailRecord={detailRecord} disposeItem={this.disposeItem} cancleDispose={this.cancleDispose}></DetailForm>}
            </>
        );
    }
}
