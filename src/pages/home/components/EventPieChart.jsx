...
class PieChart extends Component {
    ...
    shouldComponentUpdate(nextProps) {
        if (nextProps.pendingData !== this.state.pendingData) {
            return true;
        }
        return false;
    }
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        if (nextProps.pendingData !== prevState.pendingData) {
            return { pendingData: nextProps.pendingData };
        }
        return null;
    }
    ...
    initOption = () => {
        ...
        if (pendingData && pendingData.length > 0) {
            pendingData.map((item) => {
                ...
                // sum += item.deviceEventNum;
                sum += item.deviceEventNum ? item.deviceEventNum : item.deviceNum ? item.deviceNum : 0;
            });
            itemStyle = {};
            data = pendingData;
        } else {
        ...
        const option = {
            ...
            color: ['#60B1FD', '#4FCBCB', '#F3657C', '#FFDA63', '#00BCFF'],
            textStyle: {
                color: '#999999',
            },
            /**
    ...
    render() {
        return (
            <div className={indexStyle.pro}>
                {/*<div className={indexStyle.flowFont}>*/}
                {/*    <div className="tittle">总计</div>*/}
                {/*    <div className={indexStyle.flowNum}>{sum}</div>*/}
                {/*</div>*/}
