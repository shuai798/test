...
class LineChart extends Component {
    ...
    initOption = () => {
        ...
        const xData = [];
        const swingGateTotalNum = []; // 摆闸新增数量
        const wingGateTotalNum = []; // 翼闸新增数量
        const tripodTurnstileTotalNum = []; // 三辊闸新增数量
        ...
        const option = {
            ...
            legend: {
                ...
                icon: 'pin', // 图例项的 icon。ECharts 提供的标记类型包括 'circle', 'rect', 'roundRect', 'triangle', 'diamond', 'pin', 'arrow', 'none'。
            ...
            series: [
                ...
                {
                    name: '翼闸', // 系列名称，用于tooltip的显示，legend 的图例筛选，在 setOption 更新数据和配置项时用于指定对应的系列。
                    data: wingGateTotalNum, // 系列中的数据内容数组。数组项通常为具体的数据项。
                    type: 'line', // 线性
                    stack: '总量',
                    areaStyle: {},
                },
                {
                    name: '摆闸', // 系列名称，用于tooltip的显示，legend 的图例筛选，在 setOption 更新数据和配置项时用于指定对应的系列。
                    data: swingGateTotalNum, // 系列中的数据内容数组。数组项通常为具体的数据项。
                    type: 'line', // 线性。
                    stack: '总量',
                    areaStyle: {},
                },
                {
                    name: '三辊闸', // 系列名称，用于tooltip的显示，legend 的图例筛选，在 setOption 更新数据和配置项时用于指定对应的系列。
                    data: tripodTurnstileTotalNum, // 系列中的数据内容数组。数组项通常为具体的数据项。
                    type: 'line', // 线性。
                    stack: '总量',
                    areaStyle: {},
                },
    ...
    render() {
        return <div className={indexStyle.lineChartStyle} ref={this.elref}></div>;
    }
}
