...
class BarChart extends Component {
        ...
        const option = {
            ...
            series: [
                // 系列列表。每个系列通过 type 决定自己的图表类型
                {
                    ...
                    data: wingGateNewNum, // 系列中的数据内容数组。数组项通常为具体的数据项。
                    type: 'bar', // 类型。
                    /**
                ...
                },
                {
                    ...
                    data: swingGateNewNum, // 系列中的数据内容数组。数组项通常为具体的数据项。
                    type: 'bar', // 类型。
                    /**
                     * 当使用 dataset 时，seriesLayoutBy 指定了 dataset 中用行还是列对应到系列上，
                     * 也就是说，系列“排布”到 dataset 的行还是列上，可取值：'column'，'row'。
                ...
                },
                {
                    ...
                    data: tripodTurnstileNewNum, // 系列中的数据内容数组。数组项通常为具体的数据项。
                    type: 'bar', // 类型。
                    /**
                     * 当使用 dataset 时，seriesLayoutBy 指定了 dataset 中用行还是列对应到系列上，
                     * 也就是说，系列“排布”到 dataset 的行还是列上，可取值：'column'，'row'。
    ...
    render() {
        return <div className={indexStyle.barChartStyle} ref={this.elref}></div>;
    }
}
