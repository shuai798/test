            ...
            <div className="formList80 shortSearch">
                <Form layout="inline" onSubmit={this.handleFormSearch}>
                    <Row type="flex" gutter={20}>
                        <Col span={8}>
                            <FormItem label="组织名称">{getFieldDecorator('name')(<Input allowClear placeholder="请输入"></Input>)}</FormItem>
                        </Col>
                        <Col span={8}>
                            <FormItem label="组织编码">{getFieldDecorator('code')(<Input allowClear placeholder="请输入"></Input>)}</FormItem>
                        </Col>
                        <Col span={8}>
