...
class PieChart extends Component {
    ...
    shouldComponentUpdate(nextProps) {
        if (nextProps.processedData !== this.state.processedData) {
            return true;
        }
        return false;
    }
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        if (nextProps.processedData !== prevState.processedData) {
            return { processedData: nextProps.processedData };
        }
        return null;
    }
