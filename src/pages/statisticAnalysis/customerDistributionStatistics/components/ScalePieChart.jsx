...
class PieChart extends Component {
    ...
    shouldComponentUpdate(nextProps) {
        if (nextProps.customerScale !== this.state.customerScale) {
            return true;
        }
        return false;
    }
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        if (nextProps.customerScale !== prevState.customerScale) {
            return { customerScale: nextProps.customerScale };
        }
        return null;
    }
    ...
    initOption = () => {
        ...
        let itemStyle = {};
        let data = [];
        if (customerScale && customerScale.length > 0) {
