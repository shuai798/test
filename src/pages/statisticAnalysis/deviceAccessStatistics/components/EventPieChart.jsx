...
class PieChart extends Component {
    ...
    shouldComponentUpdate(nextProps) {
        if (nextProps.deviceTypeData !== this.state.deviceTypeData) {
            return true;
        }
        return false;
    }
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        if (nextProps.deviceTypeData !== prevState.deviceTypeData) {
            return { deviceTypeData: nextProps.deviceTypeData };
        }
        return null;
    }
