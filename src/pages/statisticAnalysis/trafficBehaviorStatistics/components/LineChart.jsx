    ...
    initOption = () => {
        ...
        const option = {
            ...
            series: [
                ...
                {
                    name: '通行次数', // 系列名称，用于tooltip的显示，legend 的图例筛选，在 setOption 更新数据和配置项时用于指定对应的系列。
                    data: passNum, // 系列中的数据内容数组。数组项通常为具体的数据项。
                    type: 'line', // 线性
                ...
                {
                    name: '故障数量', // 系列名称，用于tooltip的显示，legend 的图例筛选，在 setOption 更新数据和配置项时用于指定对应的系列。
                    data: breakdownNum, // 系列中的数据内容数组。数组项通常为具体的数据项。
                    smooth: false, // 是否平滑曲线显示。
                    symbol: 'circle',
                    symbolSize: 6,
                    type: 'line', // 线性。
