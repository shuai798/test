...
export async function addSettingItem(params) {
    return http.put('/uaa/w/organization', params, 'body');
}

/* 配置中编辑 */
export async function editSettingItem(params) {
    return http.put('/uaa/w/organization/{id}', params, 'body');
}

/* 配置中删除 */
export async function deleteSettingItem(params) {
    return http.delete('/uaa/w/organization/{id}', params);
}

/* 上移 */
export async function up(params) {
    return http.post('/uaa/w/organization/up/{id}', params);
}

/* 下移 */
export async function down(params) {
    return http.post('/uaa/w/organization/down/{id}', params);
}

//详情
export async function getDetailRecord(params) {
    return http.get('/uaa/w/organization/{id}', params);
}
